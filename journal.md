...
| --- | :----------------------: | :------------------: | :-------------------------------------------------------------------------------------- | :------: | :---------: | :---------: | :----: |
| 1   | Test article GET request | Run GET http request | <ol><li>Open Postman</li><li>Type URI endpint</li><li>Click GET</li><li>Click SEND</li> | /content | All content | All content |  Pass  |
